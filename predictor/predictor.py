...
def predict(x):
    ...
    for model_name in models:
        prediction = int(model_predict(model_name, x))
        models_prediction[model_name] = 'Yes' if prediction == 1 else 'No'
    ...
    models_prediction["voting_majority"] = 'Yes' if num_1 >= num_0 else 'No'
